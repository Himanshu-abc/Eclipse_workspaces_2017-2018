...
public class first_atm extends JFrame implements ActionListener{
	...
	JButton btnOk=new JButton(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\register.jpg"));
	JButton btnRegister=new JButton(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\button.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		...
		try{
				...
				ResultSet rs=st.executeQuery("SELECT * FROM  WHERE UserName='"+txtuser.getText()+"'");
				while(rs.next()){
					strUser=rs.getString(1);
