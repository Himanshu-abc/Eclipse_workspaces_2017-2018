...
import java.sql.*;
 ...
 public class second_atm extends JFrame implements ActionListener{
	...
	JButton btnCret = new JButton(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\reg.jpg"));
	...
	public second_atm() {
		...
		JLabel lbl = new JLabel(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\background.gif"));
