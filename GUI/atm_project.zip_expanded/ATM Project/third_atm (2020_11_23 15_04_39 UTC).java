...
import java.sql.*;
 ...
 public class third_atm extends JFrame implements ActionListener{
	...
	JButton btnLogOut = new JButton(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\logout.jpg"));
	...
	public third_atm() {
		...
		JLabel lbl = new JLabel(new ImageIcon("C:\\Users\\Dell\\GUI\\atm_project.zip_expanded\\ATM Project\\back.jpg"));
